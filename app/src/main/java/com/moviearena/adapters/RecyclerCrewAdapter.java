...
public class RecyclerCrewAdapter extends RecyclerView.Adapter<RecyclerCrewAdapter.Holder> {


    private ArrayList<PersonModel.Crew> list;
    ...
    public void setList(ArrayList<PersonModel.Crew> list) {
        this.list = list;
    }
