...
public class RecyclerCrewMovieBigAdapter extends RecyclerView.Adapter<RecyclerCrewMovieBigAdapter.Holder> {


    private ArrayList<PersonMoviesModel.Crew> list;
    ...
    public void setList(ArrayList<PersonMoviesModel.Crew> list) {
        this.list = list;
    }
