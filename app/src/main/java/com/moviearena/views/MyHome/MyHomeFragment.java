...
import com.moviearena.adapters.RecyclerNowPlayingAdapter;
import com.moviearena.databinding.FragmentMyHomeBinding;
...
import com.moviearena.views.category.CatsFragment;
...
public class MyHomeFragment extends Fragment implements BackListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (SharedModel.getUpcomingFilms().isEmpty() || SharedModel.getNowFilms().isEmpty()
                || SharedModel.getPopularFilms().isEmpty() || SharedModel.getTopFilms().isEmpty()){
            getData();
        }
        else{
            goLocal();
    ...
    private void goLocal(){
        ...
        ArrayList<MovieModel.ResultsDTO> list1 = new ArrayList<>(SharedModel.getPopularFilms().subList(0, 6));
        ArrayList<MovieModel.ResultsDTO> list2 = new ArrayList<>(SharedModel.getTopFilms().subList(0, 6));
        ArrayList<MovieModel.ResultsDTO> list3 = new ArrayList<>(SharedModel.getNowFilms());
        ArrayList<MovieModel.ResultsDTO> list4 = new ArrayList<>(SharedModel.getUpcomingFilms().subList(0, 6));
